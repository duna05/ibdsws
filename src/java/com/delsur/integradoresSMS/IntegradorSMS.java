...
/**
 * Integrador Base. Todos los integradores deben heredar de IntegradorSMS.
 *
 * Esta es la clase devuelta por el metodo obtenerIntegrador de la
 * FabricaDeIntegradores.
 */
public abstract class IntegradorSMS {
     ...
     * @param numSolicitud
     */
    public IntegradorSMS(int id, String nombre, String numeroTelefonico, String mensaje, int numSolicitud) {
        this.id = id;
        this.nombre = nombre;
