 ...
 */
@WebService(serviceName = "TipoIdentificacionWs")
public class TipoIdentificacionWs {
     @EJB
    private TipoIdentificacionDAO tipoidentificacionDAO;
     
     
    @WebMethod(operationName = "consultarTipoIdentificacion")
    public TipoIdentificacionDTO consultarTipoIdentificacion() {
        return tipoidentificacionDAO.consultarTipoIdentificacion();
    }
}
