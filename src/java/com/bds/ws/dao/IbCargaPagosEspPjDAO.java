 ...
 */
public interface IbCargaPagosEspPjDAO {

    /**
     * Metodo para listar las cabeceras del proceso de carga de pagos especiales Oracle 11
     *
     ...
     */
    public IbCargaPagosEspPjDTO listarIbCargaPagosEspPj(BigDecimal cdClienteAbanks, Short estatusCarga, String idCanal, String codigoCanal);

    /**
     * Metodo para insertar una nueva cabecera de proceso de carga de pagos especiales Oracle 11
     *
     * @param ibCargaPagosEspPjDTO objeto completo de IbCargaPagosEspPjDTO
     * @param pagosEspecialesDetalleDTO IbCargaPagosEspDetPjDTO
     * @param idCanal String id del canal a utilizar
    ...
    /**
     * Metodo para modificar una nueva cabecera de proceso de carga de pagos especiales Oracle 11
     *
    ...
    /**
     * Metodo para leer de la interfaz el archivo de carga de pagos especiales Oracle 11
     *
